      ...
      <div style={{ width: "100%", overflow: "hidden" }} id="background">
        {signUp && (
          ...
          >
            ...
            >
              ...
              >
                <img
                  src="3d-fluency-google-logo.png"
                  style={{
                    width: 30,
                    height: 30,
                    border: "1px solid #ccc",
                ...
                ></img>
                <img
                  src="3d-fluency-facebook-logo.png"
                  style={{
                    width: 30,
                    height: 30,
                    border: "1px solid #ccc",
                ...
                ></img>
                <img
                  src="3d-fluency-linkedin-logo.png"
                  style={{
                    width: 30,
                    height: 30,
                    border: "1px solid #ccc",
        ...
        >
          ...
          >
            ...
            <li>
              <Link to={"/toprated"}>Trending</Link>
            </li>
          </ul>
          ...
          <div style={{ width: 600 }}>
            ...
            >
              <a
                ...
                href={`https://www.imdb.com/title/tt16366836/`}
              >
                Watch
              </a>
            </button>
